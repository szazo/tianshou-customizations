...
class CollectStats(CollectStatsBase):
    ...
    # It was part of the 0.5 API, I added temporary back.
    episode_start_indices: list[int] | None = None
    """Start indices of the episodes in the buffer."""
...
class Collector(BaseCollector):
    ...
    def _collect(
        ...
        stats = CollectStats.with_autogenerated_stats(
        ...
        stats.episode_start_indices = episode_start_indices
        return stats
